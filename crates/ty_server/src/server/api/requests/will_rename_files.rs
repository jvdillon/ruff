    ...
    fn run(
        ...
        for rename in params.files {
            ...
            let (path_rename, is_directory) =
                ...
                } else if is_package_directory(system, &old_path) {
                    (
...
fn is_package_directory(system: &dyn ruff_db::system::System, path: &SystemPathBuf) -> bool {
    system.is_directory(path)
        && [path.join("__init__.py"), path.join("__init__.pyi")]
            .iter()
